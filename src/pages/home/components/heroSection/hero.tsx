export const Hero = () => {
  return (
    <div className="bg-[#DEEFF0]">
      <div className="container flex-col md:flex-row flex items-center justify-between gap-[5rem]">
      ...
      <div className="container flex-col md:flex-row flex items-center justify-between mt-[1.5rem]">
        <h6 className="mb-4 md:mb-0">Trusted by amazing companies all over the world</h6>
